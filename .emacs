...
(custom-set-variables
 ...
 '(package-selected-packages
   '(emmet-mode web-mode splash-screen-new splash-screen rainbow-identifiers color-identifiers-mode dired-sidebar rainbow-delimiters doom-themes autothemer melancholy-theme flymake-racket racket-mode deduce-mode highlight-numbers parent-mode haskell-mode ##)))
